...
@section('content_header')
    <h1><i class="fa fa-fw fa-info-circle"></i> Detalles del cliente</h1>
...
@section('content')
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <table @if ($cliente->active == 0) class="table table-danger table-striped table-hover" @else class="table table-striped table-hover" @endif>
                        <tr>
                            <th>Empresa</th>
